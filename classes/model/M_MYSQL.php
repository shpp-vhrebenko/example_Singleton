...
class M_MYSQL extends mysqli
{
    ...
    private function __construct()
    {
        ...
        if(!$this->select_db($this->dbName)) {
            ...
            $this->select_db($this->dbName);    // установка БД по умолчанию
            $this->create_articles();           // создание таблицы articles
            $this->create_comments();           // создание таблицы comments
            $this->create_data();               // заполнение таблицы articles
        }
    ...
    public function update($table, $object, $where)
    {
        ...
        $sets = implode(',', $sets);
        // UPDATE `table` SET `key`='value', `key2`='value2' WHERE id_article = 1
